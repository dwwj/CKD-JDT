...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--exp_id', default='mot17_half_sc')
    ...
    self.parser.add_argument('--dataset_version', default='17trainval')
    #self.parser.add_argument('--dataset_version', default='17test')
    ...
    self.parser.add_argument('--pre_hm', action='store_true',default='ltrb_amodal')
    ...
    self.parser.add_argument('--kd_weight', type=float, default=1)

    # custom dataset
    self.parser.add_argument('--custom_dataset_img_path', default='../data/mot17/train/')
    self.parser.add_argument('--custom_dataset_ann_path', default='../data/mot17/annotations/train.json')
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    #network head
    if 'train' in opt.dataset_version:
      opt.heads = {'hm': opt.num_classes, 'reg': 2, 'wh': 2,'kd':2}
    else:
